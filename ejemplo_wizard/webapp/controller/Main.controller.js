sap.ui.define([
	...
	"sap/m/MessageToast",
	"sap/m/MessageBox",
    "com/proy/ejemplowizard/util/Constants",
    "com/proy/ejemplowizard/util/Formatter"
],
    /**
     * @param {typeof sap.ui.core.mvc.Controller} Controller
     */
    function (Controller, JSONModel, MessageToast, MessageBox, Constants,Formatter) {
        "use strict";

        return Controller.extend("com.proy.ejemplowizard.controller.Main", {
            Formatter:Formatter,
            ...
            handleWizardCancel: function () {
                this._handleMessageBoxOpen("Are you sure you want to cancel your report?", Constants.model.warning);
            },
    
            handleWizardSubmit: function () {
                this._handleMessageBoxOpen("Are you sure you want to submit your report?", Constants.model.confirm);
            },
            ...
            setLang: function () {
                ...
                oResourceModel.enhance({ bundleName: Constants.model.module + ".i18n" });
                if(sap.ui.getCore().getConfiguration().getLanguage() === "es"){
