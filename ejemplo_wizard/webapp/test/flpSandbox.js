		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Ejemplo Wizard",
									"targetURL": "#comproyejemplowizard-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comproyejemplowizard-display": {
								"semanticObject": "comproyejemplowizard",
								"action": "display",
								"description": "A Ejemplo Wizard application.",
								"title": "App Ejemplo Wizard",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.proy.ejemplowizard",
									"url": sap.ui.require.toUrl("com/proy/ejemplowizard")
								}
							}
						}
					}
